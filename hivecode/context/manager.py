...
from hivecode.serialization import build_messages
...
SESSION_SUBDIR = ".hivecode/session/tool-results"
...
async def auto_compact(
    ...
    for attempt in range(max_retries):
        try:
            from hivecode.tools.base import StreamEnd, StreamEvent, TextDelta
