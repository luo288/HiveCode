...
from hivecode.teams.backend_detect import BackendDetectionError, detect_backend
from hivecode.teams.mailbox import Mailbox, create_message
...
from hivecode.teams.progress import TeammateProgress
from hivecode.teams.registry import AgentNameRegistry
from hivecode.teams.shared_task import SharedTaskStore
from hivecode.teams.spawn_inprocess import InProcessTeammateHandle
    ...
    def _kill_pane(self, pane_id: str, backend_type: str) -> None:
        try:
            if backend_type == BackendType.TMUX.value:
                from hivecode.teams.spawn_tmux import kill_pane
                kill_pane(pane_id)
