...
from hivecode.teams.progress import TeammateProgress, random_verb

if TYPE_CHECKING:
    from hivecode.agent import Agent
    from hivecode.conversation import ConversationManager
    from hivecode.teams.models import TeammateInfo
    ...
    async def _run() -> str:
        ...
        try:
            if conversation is not None:
                ...
                from hivecode.conversation import ConversationManager as CM
                conv = CM()
