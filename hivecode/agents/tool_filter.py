...
def build_teammate_tools(
    ...
    from hivecode.tools.send_message import SendMessageTool
    from hivecode.tools.task_create import TaskCreateTool
    from hivecode.tools.task_get import TaskGetTool
    from hivecode.tools.task_list import TaskListTool
    from hivecode.tools.task_update import TaskUpdateTool
