...
PROJECT_AGENTS_DIR = ".hivecode/agents"
USER_AGENTS_DIR = "~/.hivecode/agents"
...
class AgentLoader:
    ...
    def _load_builtins(self) -> list[AgentDef]:
        results: list[AgentDef] = []
        try:
            builtins_pkg = importlib.resources.files("hivecode.agents.builtins")
        ...
        for item in builtins_pkg.iterdir():
            ...
            try:
                ...
                from hivecode.agents.parser import parse_frontmatter, _validate_agent_meta
