...
from hivecode.skills.parser import SkillDef, substitute_arguments

if TYPE_CHECKING:
    from hivecode.agent import Agent, AgentEvent
...
class SkillExecutor:
    ...
    async def execute_fork(
        ...
        from hivecode.agent import Agent as AgentClass, StreamText, LoopComplete, ErrorEvent
