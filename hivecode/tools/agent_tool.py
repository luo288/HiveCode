...
if TYPE_CHECKING:
    from hivecode.agent import Agent
...
class AgentTool(Tool):
    ...
    async def execute(self, params: BaseModel) -> ToolResult:
        ...
        from hivecode.agents.fork import ForkError, build_forked_messages
        from hivecode.agents.parser import AgentDef
        from hivecode.agents.tool_filter import resolve_agent_tools
        from hivecode.agent import Agent as AgentClass
        ...
        if p.subagent_type is None:
            from hivecode.context import clone_replacement_state
    ...
    async def _execute_as_teammate(self, p: AgentToolParams) -> ToolResult:
        ...
        from hivecode.agents.fork import ForkError, build_forked_messages
        from hivecode.agents.parser import AgentDef
        from hivecode.agents.tool_filter import build_teammate_tools
        from hivecode.agent import Agent as AgentClass
        from hivecode.conversation import ConversationManager
        from hivecode.permissions import (
            DangerousCommandDetector,
        ...
        from hivecode.teams.models import BackendType, TeammateInfo
    ...
    def _spawn_pane_teammate(
        ...
        try:
            if backend == BackendType.TMUX:
                from hivecode.teams.spawn_tmux import spawn_tmux_teammate
                ...
                from hivecode.teams.spawn_iterm2 import spawn_iterm2_teammate
    ...
    async def _execute_with_worktree(self, p: AgentToolParams) -> ToolResult:
        ...
        from hivecode.worktree.integration import (
    ...
    def _create_client_for_model(self, model_alias: str) -> LLMClient | None:
        ...
        from hivecode.client import create_client
        from hivecode.config import ProviderConfig
