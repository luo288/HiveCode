...
from hivecode.tools.base import Tool
...
def create_default_registry(file_cache: FileCache | None = None, file_history: Any = None) -> ToolRegistry:
    from hivecode.tools.bash import Bash
    from hivecode.tools.edit_file import EditFile
    from hivecode.tools.file_state_cache import FileStateCache
    from hivecode.tools.glob import Glob
    from hivecode.tools.grep import Grep
    from hivecode.tools.read_file import ReadFile
    from hivecode.tools.write_file import WriteFile
